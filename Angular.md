...
![[Pasted image 20250708144651.png]]
...
**switchMap** - при эммите внешнего обс отписывается от него и выполняет внутрений обс **mergeMap** - выполняет при эммите внешнего обс параллельно внутрений обс
